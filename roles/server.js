...
export const Migration = {
   ...
   */
	_forwardMigrate: function(updateUser, updateRole, convertUnderscoresToDots) {
		...
		Meteor.roles.find().forEach(role => !Migration._isNewRole(role) && updateRole(role, Migration._convertToNewRole(role)));
		Meteor.users.find().forEach(user => !Migration._isNewField(user.roles) && updateUser(user, Migration._convertToNewField(user.roles, convertUnderscoresToDots)));
	},
